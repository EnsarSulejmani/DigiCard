...
const Display = () => {
  return (
    // Full Container
    <div className="w-full h-full bg-blackBackground flex flex-col">
      {/* Logo */}
      ...
      <div className="w-full flex justify-around items-center my-8 gap-8 flex-col">
        ...
        <p className="max-w-[960px] text-center">
          ...
          purus interdum malesuada. Vestibulum mauris sem, vestibulum ac dapibus
          quis, maximus id justo. Mauris sit amet tortor posuere, blandit magna
          id, dignissim erat.
        </p>
      </div>
